...
Route::prefix('{akses}/{id}')->group(function (): void {
    ...
    Route::get('data-kehadiran/lembur', [HrmController::class, 'hrm_data_kehadiran_lembur'])->name('hrm_data_kehadiran_lembur');
    ...
    Route::get('menu-koperasi/tagihan-koperasi', [KoperasiController::class, 'menu_koperasi_tagihan_koperasi'])->name('menu_koperasi_tagihan_koperasi');
...
Route::prefix('application')->group(function () {
    ...
    Route::post('menu-radiologi/data-registrasi-radiologi/handling-pasien/proses-simpan-hasil', [RadiologiController::class, 'menu_radiologi_handling_pasien_simpan_hasil'])->name('menu_radiologi_handling_pasien_simpan_hasil');
