    ...
    var LobiboxNotify = function (type, options) {
        ...
        var me = this,
            _processInput = function (options) {
                return (
                    ...
                    "mini" !== options.size && options.title === !0
                        ? (options.title =
                              Lobibox.notify.OPTIONS[me.$type].title)
                        : "mini" === options.size &&
                          options.title === !0 &&
                          (options.title = !1),
                    options.icon === !0 &&
                        (options.icon =
                            Lobibox.notify.OPTIONS.icons[options.iconSource][
                                me.$type
                            ]),
                    options.sound === !0 &&
                        (options.sound =
                            Lobibox.notify.OPTIONS[me.$type].sound),
                    options.sound &&
                        (options.sound =
                            options.soundPath +
                            options.sound +
                    ...
                    0 === $wrapper.length &&
                        ...
                        "large" === me.$options.size &&
                            $wrapper
                                ...
                                .append(
                                    $('<div class="lb-notify-wrapper"></div>')
                                )),
                    $wrapper
                );
            },
            _createNotify = function () {
                ...
                return (
                    ...
                    ("normal" === me.$options.size ||
                        "mini" === me.$options.size) &&
                        (_addCloseOnClick($notify), _addDelay($notify)),
                    me.$options.width &&
                        $notify.css(
                            "width",
                            _calculateWidth(me.$options.width)
                        ),
                    $notify
                );
            },
        ...
        (this.remove = function () {
            ...
            var parent = me.$el.parent(),
                ...
                href = "#" + parent.attr("id"),
                $li = wrapper.find(
                    '>.lb-notify-tabs>li:has(a[href="' + href + '"])'
                );
            return (
                $li
            ...
            (me.$options.showAfterPrevious &&
                0 !== Lobibox.notify.list.length) ||
                this._init();
    };
    (Lobibox.notify = function (type, options) {
        if (
            ["default", "info", "warning", "error", "success"].indexOf(type) >
            -1
        ) {
        ...
        (Lobibox.notify.DEFAULTS = {
            title: !0,
            size: "normal",
            soundPath: window.location.origin+'/asset/notifications/sounds/',
            soundExt: ".ogg",
