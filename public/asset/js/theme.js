        ...
        },
        {
            ...
            value: function clickBulkCheckbox() {
                ...
                this.element.on("click", function () {
                    if (
                        _this.element.attr("indeterminate") === "indeterminate"
                    ) {
            ...
            value: function clickRowCheckbox() {
                ...
                this.bulkSelectRows.forEach(function (el) {
                    ...
                    rowCheck.on("click", function () {
                        if (
                            _this2.element.attr("indeterminate") !==
                            "indeterminate"
                        ) {
    ...
    document
        ...
        .forEach(function (anchor) {
            anchor.addEventListener("click", function (e) {
                ...
                var el = e.target;
                var id =
                    utils.getData(el, "scroll-to") || el.getAttribute("href");
                window.scroll({
                    top:
                        (_utils$getData2 = utils.getData(el, "offset-top")) !==
                            null && _utils$getData2 !== void 0
                            ? _utils$getData2
                            : utils.getOffset(document.querySelector(id)).top -
                              100,
                    left: 0,
                    behavior: "smooth",
                });
