            ...
            <div class="row pt-7 pt-lg-8 pb-lg-0 pb-xl-0">
                <div class="col-md-11 col-lg-8 col-xl-4 pb-2 pb-xl-3 text-center text-xl-start"><a
                    ...
                    <h2 class="text-white fw-light"><strong>Innoventra</strong> <small> <span class="typed-text fw-bold"
                                data-typed-text='["Human","Resource","Management","System"]'></span></small><br />Build
                        your
                        webapp</h2>

                </div>
                <div class="col-xl-7 offset-xl-1"><a class="img-landing-banner rounded"
                            href="../index.html"><img class="img-fluid" src="{{ asset('img/ilus.png') }}"
                                alt=""  width="500"/></a></div>
            </div>
        </div>
        <!-- end of .container-->
    ...
    <section>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8 col-xl-7 col-xxl-6">
                    <!-- <a class="img-landing-banner rounded" href="../index.html"><img class="img-fluid"
                            src="{{ asset('img/display/hrm.png') }}" alt="" /></a> -->
                </div>
            </div>
            <div class="row flex-center mt-12">
                <div class="col-md col-lg-7 col-xl-7 ps-lg-6">
                    <img class="img-fluid"
                        src="{{ asset('img/display/hrm.png') }}" alt="" /></div>
                <div class="col-md col-lg-5 col-xl-4 mt-4 mt-md-0">
                    <h5 class="text-danger"><span class="far fa-lightbulb me-2"></span>DASHBOAR</h5>
                    <h3>MENU &amp; DASHBOARD </h3>
                    <p class="text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor corporis dicta nemo beatae
            ...
            <div class="row flex-center mt-7">
                <div class="col-md col-lg-5 col-xl-7 pe-lg-6 order-md-2"><img class="img-fluid px-md-0"
                        src="{{ asset('img/display/absensi.png') }}" alt="" /></div>
                <div class="col-md col-lg-5 col-xl-4 mt-4 mt-md-0">
                    <h5 class="text-info"> <span class="far fa-object-ungroup me-2"></span> DATA KEHADIRAN</h5>
                    <h3>REKAPITULASI ABSENSI</h3>
                    <p class="text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta quisquam inventore rem harum
