            ...
            <div class="card bg-200 shadow border border-primary bg-primary">
                <div class="row gx-0 flex-between-center">
                    ...
                    <div class="col-xl-auto px-3 py-2">
                        ...
                        <h4 class="text-white fw-bold mb-0" style="color: white !important;">Penerimaan <span
                                class="text-white fw-medium" style="color: white !important;">Nota</span>
                        </h4>
                    </div>
                </div>
            </div>
    ...
    <div class="card mb-3">
        <div class="card-header bg-primary">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="m-0"><span class="badge bg-primary m-0 p-0">Penerimaan Nota</span></h3>
                </div>
                <div class="col-auto">
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                            <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-master-barang-xl"
                                id="button-add-nota" data-code="123"><span class="far fa-edit"></span> Add Nota</button>
...
@section('base.js')
    ...
    <script>
        $(document).on("click", "#button-add-nota", function (e) {
            e.preventDefault();
            $('#menu-master-barang-xl').html(
                '<div class="spinner-border my-3" style="display: block; margin-left: auto; margin-right: auto;" role="status"><span class="visually-hidden">Loading...</span></div>'
            );
            $.ajax({
                url: "{{ route('inventaris_penerimaan_nota_add') }}",
                type: "POST",
                cache: false,
                data: {
                    "_token": "{{ csrf_token() }}",
        ...
        $(document).on("click", "#button-pilih-barang-invoice", function (e) {
            e.preventDefault();
            var id = $(this).data("id");
            var code = $(this).data("code");
            $('#table-barang-invoice').html(
                '<div class="spinner-border my-3" style="display: block; margin-left: auto; margin-right: auto;" role="status"><span class="visually-hidden">Loading...</span></div>'
            );
            $.ajax({
                url: "{{ route('inventaris_penerimaan_nota_add_barang') }}",
                type: "POST",
                cache: false,
                data: {
                    "_token": "{{ csrf_token() }}",
                ...
                $('#table-barang-invoice').html(data);
            }).fail(function () {
                $('#table-barang-invoice').html('eror');
            });
        });
        $(document).on("click", "#button-simpan-data-nota", function (e) {
            e.preventDefault();
            var data = $("#form-input-invoice").serialize();
            $('#menu-add-data-nota').html(
            ...
            $.ajax({
                url: "{{ route('inventaris_penerimaan_nota_save') }}",
                type: "POST",
                cache: false,
                data: {
                    "_token": "{{ csrf_token() }}",
                ...
                $('#menu-add-data-nota').html(data);
                $('#menu-add-data-nota-form').html('<span class="badge bg-primary">Berhasil Upload</span>');
                location.reload();
            }).fail(function () {
                $('#menu-add-data-nota').html('eror');
            });
        });
    </script>
@endsection
