                ...
                <div class="d-flex align-items-center">
                    <div class="toggle-icon-wrapper">
                        ...
                        <div class="d-flex align-items-center py-3">
                            <img class="me-2" src="{{ asset('img/hrm.jpg') }}" alt=""
                                width="30" /><span class="font-sans-serif fs-3">{{$code}}</span>
                        </div>
                    </a>
                </div>
                    ...
                    <div class="navbar-vertical-content scrollbar pt-2">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-items">
                                ...
                                ->where('z_menu_sub_main.menu_sub_code',$sub_menus->menu_sub_code)->get();
                                @endphp
                            <li class="nav-item">
                                ...
                                <ul class="nav collapse {{$shown}}" id="menu-{{ $sub_menus->id_menu_sub }}">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <a class="nav-link active" href="{{ url($item->menu_main_sub_code . '/' . $item->menu_main_sub_link) }}"
                                            aria-expanded="false">
                                            <div class="d-flex align-items-center ">
                                        ...
                                        @else
                                        <a class="nav-link false" href="{{ url($item->menu_main_sub_code . '/' . $item->menu_main_sub_link) }}"
                                            aria-expanded="false">
                                            <div class="d-flex align-items-center ">
                                                <span class="nav-link-icon"><span class="{{$item->menu_main_sub_icon}}"></span></span>
                                                <span class="nav-link-text fs--2"> {{$item->menu_main_sub_name}}</span>
                ...
                <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="#">
                        <div class="d-flex align-items-center"><img class="me-2"
                                ...
                                width="35" /><span class="font-sans-serif">Demo</span>
                        </div>
                    </a>
