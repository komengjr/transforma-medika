...
<head>
    <meta charset="utf-8">
    <title>{{ $data->news_data_title }} - Innoventra News</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">
    <link rel="shortcut icon" type="image/x-icon" href="{{ $data->news_data_thumbnail }}">
    <!-- Google Web Fonts -->
    ...
    <link href="{{ asset('news/lib/animate/animate.min.css') }}" rel="stylesheet">
...
<body>
                    ...
                    <div class="top-info flex-grow-0">
                        ...
                        <div class="overflow-hidden" style="width: 735px;">
                            <div id="note" class="ps-2">
                                <img src="{{ $data->news_data_thumbnail }}"
                                    class="img-fluid rounded-circle border border-3 border-primary me-2"
                                    style="width: 30px; height: 30px;" alt="">
                                <a href="#">
                                    <p class="text-white mb-0 link-hover">{{ $data->news_data_title }}</p>
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid bg-light">
            <div class="container px-0">
                <nav class="navbar navbar-light navbar-expand-xl">
                    <a href="{{ route('news_index') }}" class="navbar-brand mt-3">
                        <p class="text-primary display-6 mb-2" style="line-height: 0;">Newsers</p>
                        <small class="text-body fw-normal" style="letter-spacing: 12px;">Innoventra</small>
                    </a>
                    ...
                    <div class="collapse navbar-collapse bg-light py-3" id="navbarCollapse">
                        <div class="navbar-nav mx-auto border-top">
                            <a href="{{ route('news_index') }}" class="nav-item nav-link active">Home</a>

                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">News</a>
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a href="#" class="dropdown-item">Nasional</a>
                                    <a href="#" class="dropdown-item">Itternasional</a>
                                    <a href="#" class="dropdown-item">Regional</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column ms-2" style="width: 150px;">
                                        <span class="text-body">Pontianak,</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Innoventra</a>,
    ...
    <script src="{{ asset('news/lib/waypoints/waypoints.min.js') }}"></script>
