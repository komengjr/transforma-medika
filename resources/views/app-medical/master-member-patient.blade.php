            ...
            <div class="card bg-200 shadow border border-primary bg-primary">
                <div class="row gx-0 flex-between-center" style="color: white !important;">
                    <div class="col-sm-auto d-flex align-items-center border-bottom">
                        <img class="ms-3 mx-3 m-2" src="{{ asset('img/member.png') }}" alt="" width="50" />
                        <div>
                    ...
                    <div class="col-xl-auto px-3 py-2">
                        ...
                        <h4 class="text-white fw-bold mb-0">Member <span class="text-white fw-medium">Pasien</span>
                        </h4>
                    </div>
                </div>
            </div>
    ...
    <div class="card mb-3">
        <div class="card-header bg-primary">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="m-0"><span class="badge bg-primary m-0 p-0">Member Pasien</span></h3>
                </div>
                <div class="col-auto">
