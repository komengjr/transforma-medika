...
<head>
    ...
    <style>
        ...
        div#pannel div#control input#connection {
        ...
        div#pannel div#control input#connection:hover {
            background-color: #1166FF;
        }

        div#pannel div#control input#connection:active {
            margin-left: 14px;
        }


        div#pannel div#control input#idScanDocument {
            display: inline-block;
            float: left;
            width: 149px;
            height: 30px;
        ...
        div#pannel div#control input#idScanDocument:hover {
            background-color: #1166FF;
        }

        div#pannel div#control select#httpOrHttps {
            display: inline-block;
            width: 80px;
            height: 30px;
            margin-top: 21px;
        ...
        div#pannel div#control select#DevType {
            display: inline-block;
            width: 140px;
            height: 30px;
            margin-top: 21px;
        ...
        div#pannel div#control div#divPaddingDummy {
            display: inline-block;
            width: 100%;
            padding-bottom: 28px;
        }

        div#pannel div#control div#divDevStatus {
            display: inline-block;
            padding-left: 20px;
        }

        div#pannel div#control div#divDevStatus span#deviceStatus {
            color: #333333;
            font-family: "Microsoft YaHei";
            font-size: 16px;
        }

        div#pannel div#control div#divDevStatus span.cDevStatusKey {
            color: #999999;
            font-family: "Microsoft YaHei";
            font-size: 16px;
            margin-left: 46px;
        ...
        div#pannel div#cardInfo div#divTextArea {
            position: relative;
            width: 100%;
            height: 260px;
            margin-bottom: 15px;
        ...
        div#pannel div#cardInfo div#divTextArea div.cTextItem {
            display: block;
            width: 100%;
            min-height: 36px;
            margin-top: 10px;
        ...
        div#pannel div#cardInfo div#divTextArea div.cTextItem span.cTextKey {
            display: inline-block;
            width: 120px;
            padding-left: 16px;
            color: #999999;
        ...
        div#pannel div#cardInfo div#divTextArea div.cTextItem input.cTextSource {
            display: inline-block;
            width: 80px;
            min-height: 36px;
            color: #333333;
        ...
        div#pannel div#cardInfo div#divTextArea div.cTextItem input.cTextValue {
            display: inline-block;
        ...
        div#pannel div#cardInfo div#divImages {
            position: absolute;
            width: 100%;
            height: 325px;
            background-color: #F1F1F1;
        ...
        div#pannel div#cardInfo div#divImages div#divSmallImages {
            position: absolute;
            width: 78px;
            height: 100%;
            display: inline-block;
        ...
        div#pannel div#cardInfo div#divImages div#divSmallImages img {
            cursor: hand;
        }

        div#pannel div#cardInfo div#divImages div#divSmallImages div.cDivSmallImage {
            display: block;
            height: calc(20% - 7px);
            width: 100%;
            display: flex;
        ...
        div#pannel div#cardInfo div#divImages div#divSmallImages div.cDivSmallImage img.cImage {
            position: relative;
            max-height: 100%;
            max-width: 100%;
            display: block;
        ...
        div#pannel div#cardInfo div#divImages div#divSmallImages div.cDivSmallImage img.cImageLast {
            position: relative;
            max-height: 100%;
            max-width: 100%;
            display: block;
        ...
        div#pannel div#cardInfo div#divImages div#divBigImage {
            position: absolute;
            top: 0;
            left: 88px;
            height: 100%;
        ...
        div#pannel div#cardInfo div#divImages div#divBigImage .bigImage {
            position: relative;
            float: left;
            max-width: 100%;
            max-height: 100%;
        ...
        <div id="cardInfo">
            ...
            <div id="divImages">
                <div id="divSmallImages">
                    <div class="cDivSmallImage"><img id="imageWhite" class="cImage" src="png/Home_pic_bgicon.png"
                            onclick="showImage('imageWhite');" /></div>
                    <div class="cDivSmallImage"><img id="imageIR" class="cImage" src="png/Home_pic_bgicon.png"
                            onclick="showImage('imageIR');" /></div>
                    <div class="cDivSmallImage"><img id="imageUV" class="cImage" src="png/Home_pic_bgicon.png"
                            onclick="showImage('imageUV');" /></div>
                    <div class="cDivSmallImage"><img id="imageOcrHead" class="cImage" src="png/Home_pic_bgicon.png"
                            onclick="showImage('imageOcrHead');" /></div>
                    <div class="cDivSmallImage"><img id="imageChipHead" class="cImage" src="png/Home_pic_bgicon.png"
                            onclick="showImage('imageChipHead');" /></div>
                </div>
