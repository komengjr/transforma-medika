                ...
                <td class="text-center">
                    @if ($supp)
                        @if ($supp->pem_pr_order_datas_status == 1)
                            <button class="btn btn-falcon-success btn-sm m-0" id="button-terima-barang-purchase-order"
                                data-code="{{$info->pem_pr_order_code}}" data-id="{{ $datas->pem_pr_req_data_code }}"><span
