            ...
            <div class="card bg-200 shadow border border-primary bg-primary">
                <div class="row gx-0 flex-between-center" style="color: white !important;">
                    <div class="col-sm-auto d-flex align-items-center border-bottom">
                        <img class="ms-3 mx-3 m-2" src="{{ asset('img/cash.png') }}" alt="" width="50" />
                        <div>
                    ...
                    <div class="col-xl-auto px-3 py-2">
                        ...
                        <h4 class="text-white fw-bold mb-0" style="color: white !important;">Cash <span
                                class="text-white fw-medium" style="color: white !important;">Purchase</span>
                        </h4>
                    </div>
                </div>
            </div>
    ...
    <div class="card mb-3">
        <div class="card-header bg-primary">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="m-0"><span class="badge bg-primary m-0 p-0">Cash Purchase</span></h3>
                </div>
                <div class="col-auto">
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modal-pr-xl"
                                    id="button-preview-purchase-cash"
                                    data-code="{{ $datas->pem_pr_cash_code }}">Print</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
...
@section('base.js')
    ...
    <script>
        $(document).on("click", "#button-preview-purchase-cash", function (e) {
            e.preventDefault();
            var code = $(this).data("code");
            $.ajax({
                url: "{{ route('purchase_cash_purchase_preview') }}",
                type: "POST",
                cache: false,
                data: {
                    "_token": "{{ csrf_token() }}",
