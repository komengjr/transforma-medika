...
<body>
    ...
    <main>
        <div id="details" class="clearfix">
            <div id="client">
                <table style="margin: 0px; padding: 0px; font-size: 0.7em;">
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{$info->pem_pr_order_no}}</td>
                    </tr>
                    <tr>
                        <td>Tanggal Order</td>
                        <td>:</td>
                        <td>{{$info->pem_pr_order_date}}</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
            ...
            <div id="invoice">
                <span style="font-size: 1em;color: #1ac300ff;"><strong>PURCHASE ORDER</strong></span>
                ...
                <img src="data:image/png;base64,' . {{DNS1D::getBarcodePNG($info->pem_pr_order_no, 'C39', 1, 35)}} . '"
                    alt="barcode" />
            </div>
        </div>
        <br>
            ...
            <table
                ...
                <tr>
                    <td class="text-center"
                        ...
                        <br><br><br>
                        @php
                            $user = DB::table('user_mains')->where('userid', $info->pem_pr_order_create_by)->first();
                        @endphp
