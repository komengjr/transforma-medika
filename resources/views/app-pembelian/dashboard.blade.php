...
<style>
    ...
    .bg-gradient-indigo  { background: linear-gradient(45deg, #4338ca, #3730a3); }
    .bg-gradient-emerald { background: linear-gradient(45deg, #059669, #047857); }
    .bg-gradient-amber   { background: linear-gradient(45deg, #d97706, #b45309); }
    .bg-gradient-blue    { background: linear-gradient(45deg, #0284c7, #0369a1); }
    .bg-gradient-purple  { background: linear-gradient(45deg, #7c3aed, #6d28d9); }
    .bg-gradient-rose    { background: linear-gradient(45deg, #e11d48, #be123c); }
</style>
