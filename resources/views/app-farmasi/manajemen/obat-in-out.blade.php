            ...
            <div class="card bg-200 shadow border border-warning">
                <div class="row gx-0 flex-between-center">
                    ...
                    <div class="col-xl-auto px-3 py-2">
                        ...
                        <h4 class="text-warning fw-bold mb-0">Manajemen <span class="text-warning fw-medium">Obat Masuk dan Keluar</span>
                        </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between">
                <div>
                    ...
                    <button class="btn btn-falcon-default btn-sm mb-1" type="button" data-bs-toggle="tooltip"
                        data-bs-placement="top" title="" data-bs-original-title="Obat Masuk" aria-label="Archive">
            ...
            <table id="example" class="table table-bordered table-striped" style="width:100%">
                <thead class="bg-800 text-200 fs--2">
                    <tr>
                        ...
                        <th class="sort" data-sort="reg">No Obat</th>
                        <th class="sort" data-sort="name">Nama Obat</th>
                        <th class="sort" data-sort="tgl">Kategori</th>
                        <th class="sort" data-sort="poli">Jenis</th>
                        <th class="sort" data-sort="doc">Satuan</th>
                        <th class="sort" data-sort="status">Status Obat</th>
                ...
                <tbody class="fs--2">
                    ...
                    @foreach ($data as $datas)
                        ...
                        <tr>
                            <td class="no">{{ $no++ }}</td>
                            <td class="reg fw-bold">{{ $datas->farm_data_obat_code }}
                            </td>
                            <td class="name">{{ $datas->farm_data_obat_name }}</td>
                            <td class="tgl">{{ $datas->farm_data_obat_cat }}</td>
                            <td class="poli">{{ $datas->farm_data_obat_jenis }}</td>
                            <td class="doc">{{ $datas->farm_data_obat_satuan }}</td>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                        @if ($datas->d_reg_order_poli_status == 0)
                                            <button class="dropdown-item text-warning" data-bs-toggle="modal"
                                                ...
                                                data-code="{{ $datas->farm_data_obat_code }}"><span class="fas fa-dna"></span>
