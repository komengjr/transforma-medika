...
<head>
    <meta charset="utf-8">
    <title>Newsers - Innoventra Magazine Site</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('img/news.png') }}">
    <!-- Google Web Fonts -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Innoventra</a>, All right reserved.</span>
                </div>
