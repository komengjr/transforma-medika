...
<div class="modal-body p-0">
    ...
    <form method="POST" action="#" enctype="multipart/form-data" id="form-add-data-item">
        @csrf
            ...
            <div class="card-body ">
                <div class="card border border-primary">
                    <div class="row g-4 p-4">
                        ...
                        <div class="col-md-5">
                            <label for="inputPassword4" class="form-label text-danger">Nama Item</label>
                            <input type="text" name="name" class="form-control form-control-lg" id="nama_barang"
                                required>

                            <label for="inputEmail4" class="form-label text-danger">Klasifikasi Item</label>
                            <select class="form-control choices-single-jenis" name="class" id="class"
                                required>
                                <option value="">Pilih Class Item</option>
                                <option value="BHP">Bahan Habis Pakai</option>
                                <option value="BTHP">Bahan Tidak Habis Pakai</option>
                            </select>

                            <label for="inputPassword4" class="form-label text-danger">Type Item</label>
                            <select class="form-control form-control-lg kategori_barang" name="type" required>
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="text" name="barcode" class="form-control form-control-lg" id="barcode"
                                required>

                            <label for="inputEmail4" class="form-label text-danger">Satuan Terkecil Barang</label>
                            <select class="form-control choices-single-lokasi" name="satuan" id="satuan">
...
<script type="text/javascript">
    ...
    var resumable = new Resumable({
        target: "{{ route('master_logistik_add_item_upload_file') }}",
        query: {
            _token: '{{ csrf_token() }}'
        }, // CSRF token
