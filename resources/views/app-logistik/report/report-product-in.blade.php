            ...
            <div id="client">
                <table style="margin: 0px; padding: 0px; font-size: 0.7em;">
                    ...
                    <tr>
                        ...
                        <td style="padding-top: 0;padding-bottom: 0px;">:</td>
                        <td style="padding: 0;"><strong style="color: red;">123</strong>
                        </td>
                    </tr>
                </table>
            </div>
            <div id="invoice">
                <span style="font-size: 1em;color: #0087C3; font-weight: 800;"><strong>BARANG MASUK
                        LOGISTIK</strong></span>
                ...
                <img src="data:image/png;base64,' . {{DNS1D::getBarcodePNG(21322222222222, 'C39', 1, 35)}} . '"
                    alt="barcode" />
            </div>
        </div>
            ...
            <tbody id="invoiceItems" style="font-size: 8px;">
                ...
                @foreach ($product as $products)
                    <tr>
                        ...
                        <td>{{ $products->master_item_name }} <br> <small class="text-warning">No Grn :
                                {{ $products->pem_grn_token_number }}</small> </td>
                        <td style="text-align: right;">{{ $products->pem_pr_order_datas_qty }} / <small>
                                {{ $products->master_item_opt }}</small></td>
                        <td style="text-align: right;">@currency($products->pem_pr_order_datas_harga)</td>
                        <td style="text-align: center;">{{ $products->pem_pr_order_datas_discount }} %</td>
