        ...
        <div class="hero-header p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <p class="text-white-50 mb-0 small" style="font-size: 0.72rem;">Kelola rujukan, satuan, metode, perkalian, param, dan sub-parameter.</p>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" style="max-width: 95%;">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <form id="form-setting-param">
                ...
                <div class="modal-body p-3" style="max-height: 75vh; overflow-y: auto; background: #f8fafc;">
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Handle Klik Tombol 'Setting Parameter'
        $(document).on('click', '.btn-setting-param', function() {
            ...
            $('#param-container').html(`
                    <div class="custom-loader">
                        ...
                        <span class="fw-bold text-muted small">Mengambil parameter...</span>
                    </div>
                `);
        ...
        $('#form-setting-param').on('submit', function(e) {
            ...
            $.ajax({
                ...
                error: function(err) {
                    btnSave.prop('disabled', false).html('<i class="fas fa-save me-1"></i> Simpan Semua Parameter');
                    alert('Gagal menyimpan data parameter.');
                }
            });
        });
    });

    // Mapping Data Existing berdasarkan t_pem_list_val_opt_code
    function populateExistingData(paramList) {
        $('#param-container').html('');
        rowIdx = 0;

        // Filter Parent: yang t_pem_list_val_opt_code NULL atau kosong
        ...
        parents.forEach(parent => {
            ...
            // Filter Child yang t_pem_list_val_opt_code nya sama dengan kode parent
                ...
                <div class="param-row ${bgClass}" id="row-${rowIdx}" data-row-id="${rowIdx}">
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-md-1">
                            ...
                            <input type="text" name="items[${rowIdx}][param]" class="form-control form-control-sm" value="${data ? (data.t_pem_list_val_param || '') : ''}" placeholder="Input Code">
                        </div>
                        <div class="col-md-1">
                            <label class="form-label text-muted mb-1" style="font-size:0.65rem;">Metode</label>
                            <input type="text" name="items[${rowIdx}][metode]" class="form-control form-control-sm" value="${data ? (data.t_pem_list_val_metode || '') : ''}" placeholder="Impedance">
                        </div>
                        <div class="col-md-1">
