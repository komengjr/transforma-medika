            ...
            <div class="card bg-200 shadow border border-primary">
                <div class="row gx-0 flex-between-center">
                    ...
                    <div class="col-xl-auto px-3 py-2">
                        ...
                        <h4 class="text-primary fw-bold mb-0">Kategori <span class="text-primary fw-medium">Layanan</span>
                        </h4>
                    </div>
                </div>
            </div>
    ...
    <div class="card mb-3">
        <div class="card-header bg-warning text-github">
            <div class="row align-items-center">
                <div class="col">
                    <h4 class="m-0 text-white fw-bold">Kategori Layanan</h4>
                </div>
                <div class="col-auto">
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                            <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-pemeriksaan"
                                id="button-add-kategori-layanan" data-code="123"><span class="far fa-edit"></span>
                                Tambah Kategori Layanan</button>
            ...
            <table id="example" class="table table-striped nowrap" style="width:100%">
                ...
                <tbody>
                    ...
                    @foreach ($data as $datas)
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>{{ $datas->t_layanan_cat_code }}</td>
                            <td>{{ $datas->t_layanan_cat_name }}</td>
                            <td>{{ $datas->t_layanan_cat_status }}</td>
                            <td>
                                <div class="btn-group" role="group">
                                    <button class="btn btn-sm btn-falcon-primary dropdown-toggle" id="btnGroupVerticalDrop2"
...
@section('base.js')
    ...
    <script>
        $(document).on("click", "#button-add-kategori-layanan", function(e) {
            e.preventDefault();
            ...
            $.ajax({
                url: "{{ route('master_layanan_category_add') }}",
                type: "POST",
                cache: false,
                data: {
                    "_token": "{{ csrf_token() }}",
