<div class="modal-body p-0">
    ...
    <form class="row g-3 p-4" action="{{ route('master_pemeriksaan_data_save') }}" method="post"
        ...
        <div class="col-6">
            ...
            <select name="code" class="form-control choices-single-jenis" id="">
                ...
                @foreach ($cat as $cats)
                    <option value="{{ $cats->t_pemeriksaan_cat_code }}">{{ $cats->t_pemeriksaan_cat_name }}</option>
                @endforeach
            </select>
        </div>
        <div class="col-6">
