            ...
            <div class="card bg-200 shadow border border-primary">
                <div class="row gx-0 flex-between-center">
                    ...
                    <div class="col-xl-auto px-3 py-2">
                        ...
                        <h4 class="text-primary fw-bold mb-0">Kategori <span
                                class="text-primary fw-medium">Pemeriksaan</span>
                        </h4>
                    </div>
                </div>
            </div>
    ...
    <div class="card mb-3">
        <div class="card-header bg-github text-github">
            <div class="row align-items-center">
                <div class="col">
                    <h4 class="m-0 text-warning fw-bold">Kategori Pemeriksaan</h4>
                </div>
                <div class="col-auto">
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                            <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-pemeriksaan"
                                id="button-add-kategori-pemeriksaan" data-code="123"><span class="far fa-edit"></span>
                                Tambah Kategori Pemeriksaan</button>
        ...
        <div class="card-body border-top p-3">
            <table id="example" class="table table-striped nowrap" style="width:100%">
                <thead class="bg-200 text-700">
                    <tr>
                        <th>No</th>
                        <th>Kode Kategori Pemeriksaan</th>
                        <th>Nama Kategori Pemeriksaan</th>
                        <th>Status Kategori Pemeriksaan</th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    @foreach ($data as $datas)
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>{{ $datas->t_pemeriksaan_cat_code }}</td>
                            <td>{{ $datas->t_pemeriksaan_cat_name }}</td>
                            <td>{{ $datas->t_pemeriksaan_cat_status }}</td>
                            <td>
                                <div class="btn-group" role="group">
                                    <button class="btn btn-sm btn-falcon-primary dropdown-toggle" id="btnGroupVerticalDrop2"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                        <button class="dropdown-item" data-bs-toggle="modal"
                                            data-bs-target="#modal-pemeriksaan" id="button-add-kategori-pemeriksaan"
                                            data-code="123"><span class="far fa-edit"></span>
                                            Update Kategori Pemeriksaan</button>
                                        <div class="dropdown-divider"></div>
                                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-cabang"
...
@section('base.js')
    ...
    <script>
        $(document).on("click", "#button-add-kategori-pemeriksaan", function(e) {
            e.preventDefault();
            ...
            $.ajax({
                url: "{{ route('master_pemeriksaan_category_add') }}",
                type: "POST",
                cache: false,
                data: {
                    "_token": "{{ csrf_token() }}",
