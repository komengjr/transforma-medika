            ...
            <div class="card bg-200 shadow border border-danger">
                <div class="row gx-0 flex-between-center">
                    ...
                    <div class="col-xl-auto px-3 py-2">
                        ...
                        <h4 class="text-danger fw-bold mb-0">Master <span class="text-danger fw-medium">Pemeriksaan</span>
                        </h4>
                    </div>
                </div>
            </div>
    ...
    <div class="card mb-3">
        <div class="card-header bg-danger">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="m-0"><span class="badge bg-danger m-0 p-0">Master Pemeriksaan</span></h3>
                </div>
                <div class="col-auto">
            ...
            <table id="example" class="table table-striped nowrap" style="width:100%">
                ...
                <tbody>
                    ...
                    @foreach ($data as $datas)
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>{{ $datas->master_pemeriksaan_code }}</td>
                            <td>{{ $datas->master_pemeriksaan_name }}</td>
                            <td>
                                @if ($datas->master_pemeriksaan_status == 0)
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                        <button class="dropdown-item" data-bs-toggle="modal"
                                            data-bs-target="#modal-pemeriksaan" id="button-edit-pemeriksaan"
                                            data-code="{{ $datas->master_pemeriksaan_code }}"><span
                                                class="far fa-edit"></span>
                                            Edit Pemeriksaan</button>
                                    </div>
                                </div>
                            </td>
                        </tr>
...
@section('base.js')
    ...
    <script>
        $(document).on("click", "#button-add-pemeriksaan", function(e) {
            e.preventDefault();
