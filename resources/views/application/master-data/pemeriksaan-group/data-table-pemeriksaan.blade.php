    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                @foreach ($pem as $pems)
                <li>
                    {{ $pems->t_pem_list_val_name }} <br><small>{{ $pems->t_pem_list_val_rujukan }}, {{ $pems->t_pem_list_val_satuan }}</small> <br>
                    <small class="text-primary">{{ $pems->t_pem_list_val_instrumen }} - {{ $pems->t_pem_list_val_param }}</small>
                </li>
                @endforeach
            </td>
            <td></td>
