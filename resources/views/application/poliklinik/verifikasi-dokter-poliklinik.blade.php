        ...
        <div class="card bg-200 shadow border border-warning">
            <div class="row gx-0 flex-between-center">
                ...
                <div class="col-xl-auto px-3 py-2">
                    ...
                    <h4 class="text-warning fw-bold mb-0">Poliklinik <span class="text-warning fw-medium">Verifikasi</span>
                    </h4>
                </div>
            </div>
        </div>
    ...
    <div class="card-header bg-warning">
        <div class="d-flex justify-content-between">
            <div>
                ...
                <button class="btn btn-falcon-default btn-sm mb-1" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Pencarian Data" aria-label="Archive">
