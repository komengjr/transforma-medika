        ...
        <div class="card mb-3">
            <div class="card-header bg-300">
                <div class="row flex-between-center">
                    ...
                    <div class="col-sm-auto"><a class="btn btn-falcon-default btn-sm" href="#!"><span class="fas fa-search me-2" data-fa-transform="shrink-2"></span>Find</a></div>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <input type="text" class="form-control form-control-lg text-center" id="carinoregister" placeholder="Search No Registrasi"
                            onkeydown="search(this)" autofocus>
                    </div>
                </div>
            </div>
        </div>
        <div class="card">
            <span id="menu-order-cashier">
                <div class="card-header bg-300 btn-reveal-trigger d-flex flex-between-center">
                    ...
                    <a class="btn btn-falcon-warning btn-sm btn-reveal" href="#"><span class="fab fa-product-huntt"></span> Payment
                    </a>
                </div>
            </span>
        </div>
            ...
            <div class="card-body">
                <form>
                    ...
                    <div class="form-check mb-0">
                        ...
                        <label class="form-check-label mb-2 fs-1 text-primary" for="credit-card">Cash
                        </label>
                    </div>
                    <div class="row gx-0 ps-2 mb-2">
                        <div class="col-sm-12 px-3">
                            <div class="mb-0">
                                <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0" for="inputNumber">Nominal</label>
                                <input class="form-control" id="inputNumber" type="text" placeholder="@currency(0)" />
                            </div>
                        </div>
                    </div>
                    <div class="form-check mb-0">
                        <input class="form-check-input" type="radio" value="" id="debit-card" name="payment-method" />
                        <label class="form-check-label mb-2 fs-1 text-primary" for="credit-card">Debit Card
                        </label>
                    </div>
                    <div class="row gx-0 ps-2 mb-2">
                        <div class="col-sm-12 px-3">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0">EDC<a class="d-inline-block" href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Card verification value"><span class="fa fa-question-circle ms-2"></span></a></label>
                    ...
                    <div class="form-check mb-0">
                        <input class="form-check-input" type="radio" value="" id="credit-card" name="payment-method" />
                        <label class="form-check-label mb-2 fs-1 text-primary" for="credit-card">Credit Card
                        </label>
                    </div>
                    <div class="row gx-0 ps-2 mb-2">
                        <div class="col-sm-12 px-3">
                        ...
                        <div class="col-12 ps-3 text-center pt-2 d-none d-sm-block">
                            <div class="rounded-1 p-2 mt-3 border">
                                <div class="text-uppercase fs--2 fw-bold">We Accept</div><img src="{{ asset('asset/img/icons/icon-payment-methods-grid.png') }}" alt="" width="220" />
                            </div>
                        </div>
                    </div>
                    <div class="form-check d-flex align-items-center">
                    ...
                    <div class="row" style="display: none;" id="menu-pembayaran">
                        ...
                        <div class="col-md-5 col-xl-12 col-xxl-5 ps-lg-4 ps-xl-2 ps-xxl-5 text-center text-md-start text-xl-center text-xxl-start">
                            ...
                            <div class="fs-2 fw-semi-bold">All Total: <span class="text-primary" id="total_pembayaran_pasien">0</span></div>
                            <button class="btn btn-success mt-3 px-5" type="button" id="button-fix-pembayaran-pasien">Confirm &amp; Pay</button>
...
@endsection
@section('base.js')
<div class="modal fade" id="modal-cashier-full" data-bs-keyboard="false" data-bs-backdrop="static"
