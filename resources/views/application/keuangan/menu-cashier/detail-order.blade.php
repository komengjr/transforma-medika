<div class="card-header bg-300 btn-reveal-trigger d-flex flex-between-center">
    ...
    <a class="btn btn-falcon-warning btn-sm btn-reveal" href="#" id="button-proses-payment"><span class="fab fa-product-huntt"></span> Payment
    </a>
</div>
        ...
        <div class="col-md-2 d-flex justify-content-center">
            <div class="avatar avatar-5lg shadow-sm justify-content-center">
                <div class="h-100 w-100 overflow-hidden">
                    <img src="{{ asset($pasien->master_patient_profile) }}" class="img-thumbnail " alt=""
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group"> <span class="input-group-text"><i
                        ...
                        <input type="text" name="nik"
                            ...
                            value="{{ $pasien->master_patient_nik }}" disabled>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group"> <span class="input-group-text"><i
                        ...
                        <input type="text" name="nik"
                            class="form-control form-control-lg border-start-0 bg-white" id="nik"
                            value="{{ $pasien->master_patient_code }}" disabled>
...
<div class="card-body">
    ...
    <table class="table table-borderless fs--1 mb-0 border">
        ...
        <tr class="border-bottom">
            ...
            <th class="ps-0 text-black">{{$hargas->t_pemeriksaan_list_name}}
                <div class="text-400 fw-normal fs--2">Normal Price : @currency($hargas->order_rad_log_price) Disc. {{$hargas->order_rad_log_discount}} %</div>
            </th>
            <th class="fs-1 text-end">@currency($hargas->order_rad_log_price - ($hargas->order_rad_log_discount*$hargas->order_rad_log_price/100))</th>
        </tr>
        @php
    ...
    <table class="table table-borderless fs--1 mb-0 border">
        ...
        <tr class="border-bottom">
            ...
            <th class="ps-0 text-black">{{$hargas->t_pemeriksaan_list_name}}
                <div class="text-400 fw-normal fs--2">Normal Price : @currency($hargas->order_lab_log_price) Disc. {{$hargas->order_lab_log_discount}} %</div>
            </th>
            <th class="fs-1 text-end">@currency($hargas->order_lab_log_price - ($hargas->order_lab_log_discount*$hargas->order_lab_log_price/100))</th>
        </tr>
        @php
