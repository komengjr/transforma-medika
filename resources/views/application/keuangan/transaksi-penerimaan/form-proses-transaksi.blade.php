<div class="modal-body p-0">
    <div class="bg-300 rounded-top-lg py-3 ps-4 pe-6">
        <h4 class="mb-1" id="staticBackdropLabel">Proses Transaksi Penerimaan</h4>
        <p class="fs--2 mb-0">Support by <a class="link-600 fw-semi-bold" href="#!">Transforma</a></p>
    </div>
    <div class="p-4">
        <div class="row g-3">
            <div class="col-md-2 d-flex justify-content-center">
                <div class="avatar avatar-5xl shadow-sm img-thumbnail justify-content-center border">
                    <div class="h-100 w-100 overflow-hidden">
                        <img src="{{ asset($data->master_patient_profile) }}" width="200" alt="" id="videoPreview"
            ...
            <!-- <div class="col-12">
                <span id="menu-handling-pasien-lab">
                    <button class="btn btn-warning float-end" id="button-handling-pasien-lab" >Proses
                        Handling</button>
                </span>
            </div> -->
        </div>
