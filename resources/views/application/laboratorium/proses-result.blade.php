...
<style>
    #button-proses-result-lab:hover {
        cursor: pointer;
        ...
        <div class="card bg-200 shadow border border-primary">
            <div class="row gx-0 flex-between-center">
                ...
                <div class="col-xl-auto px-3 py-2">
                    ...
                    <h4 class="text-primary fw-bold mb-0">Laboratorium <span
                            class="text-primary fw-medium">Proses Result</span>
                    </h4>
                </div>
            </div>
        </div>
...
<div class="row g-0">
        ...
        <div class="sticky-sidebar">
            <div class="card mb-lg-0">
                <div class="card-header bg-300">
                    <h5 class="mb-0">Proses Result</h5>
                </div>
                <div class="card-body bg-light">
                    <div class="col-12 mb-2">
                        <div class="input-group mb-2"> <span class="input-group-text"><i
                                    class="fas fa-calendar-day"></i></span>
                            <input class="form-control datetimepicker form-control-lg" id="timepicker3" type="text" placeholder="d/m/y to d/m/y" data-options='{"mode":"range","dateFormat":"d/m/y","disableMobile":true,"locale":"en"}' />
                        </div>
                        <div class="input-group"> <span class="input-group-text"><i
                                    class="fas fa-qrcode"></i></span>
                            <input type="text" name="no_reg"
                                class="form-control form-control-lg border-start-0 bg-white" id="no_reg" placeholder="Scan Disini" onkeydown="search(this)" autofocus>
                        </div>
                    </div>
                    @foreach ($data as $datas)
                    <div class="col-12 mb-2">
                        <div class="card border h-100 border-warning remove-class" id="button-proses-result-lab"
                            ...
                            <div class="card-body fs--2 text-dark py-2">
                                ...
                                <p class="card-text">No. reg : <strong class="text-warning">{{ $datas->d_reg_order_lab_code }}</strong>, Tanggal Registrasi
                                    <strong class="text-dark">{{ $datas->d_reg_order_lab_date }}</strong>
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-lg-8 ps-lg-2">
        <span id="menu-detail-result"></span>
    </div>
</div>
<div class="card mt-0">
    <div class="card-body">
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    Swal.fire({
                        title: "Saved!",
                        text: "Your Result has been Save.",
                        icon: "success"
                    });
                    $('#menu-detail-result').html(data);
                }).fail(function() {
                    Swal.fire({
                        title: "Failed!",
                        text: "Your Result has been Unsave.",
                        icon: "error"
                    });
                });
