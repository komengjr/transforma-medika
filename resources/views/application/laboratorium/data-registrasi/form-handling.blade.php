<div class="modal-body p-0">
    <div class="bg-300 rounded-top-lg py-3 ps-4 pe-6">
        <h4 class="mb-1" id="staticBackdropLabel">Handling Pasien Radiologi</h4>
    ...
    @if ($payment)
        <div class="p-4">
            <div class="row g-3">
                                ...
                                <div class="card shadow-none border-bottom rounded-0">
                                    <div class="card-header p-0" id="faqAccordionHeading2">
                                        <button
                                            ...
                                            <span class="far fa-dot-circle me-3"></span>
                                            <span class="fw-medium font-sans-serif text-warning">Suhu
                                                Badan</span></button>
                                    </div>
                                    <div class="bg-light collapse show" id="collapseFaqAccordion2"
                                        aria-labelledby="faqAccordionHeading2" data-parent="#accordionFaq" >
                                        <div class="card-body">
                                            <p class="ps-4 mb-0">You can issue either partial or full refunds. There
                                                are no
                ...
                <div class="col-12">
                    <span id="menu-handling-pasien-lab">
                        <button class="btn btn-warning float-end" id="button-handling-pasien-lab"
    ...
    @else
        <div class="p-4">
            <div class="card border">
                <div class="card-body ">
                    <p class="lead mt-2 font-sans-serif fw-semi-bold w-md-75 w-xl-100 mx-auto text-danger">Pembayaran Belum Lunas</p>
                    <hr>
                    <p>Pastikan Pasien Sudah Melakukan Pembayaran Terlebih Dahulu</p>
                </div>
            </div>
        </div>
    @endif
