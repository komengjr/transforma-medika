<div class="card mb-3">
    ...
    <div class="card-body bg-light" id="menu-proses-specimen-collection">
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-end">
                            ...
                            <span id="menudata{{$pem->id_t_pemeriksaan_list}}{{ $spec->id_s_specimen_data  }}">
                                ...
                                <button class="btn btn-falcon-warning btn-sm" id="button-simpan-specimen{{$pem->id_t_pemeriksaan_list}}{{ $spec->t_pem_specimen_code  }}" data-code="{{$pem->id_t_pemeriksaan_list}}" data-specimen="{{ $spec->t_pem_specimen_code }}" data-reg="{{ $code }}">{{ $log->s_specimen_log_time }}</button>
                                @else
                            ...
                            @else
                            <span id="menudata{{$pem->id_t_pemeriksaan_list}}{{ $spec->id_s_specimen_data  }}">
                                <button class="btn btn-falcon-danger btn-sm" id="button-collection-specimen{{$pem->id_t_pemeriksaan_list}}{{ $spec->id_s_specimen_data  }}" data-code="{{$pem->id_t_pemeriksaan_list}}" data-specimen="{{ $spec->t_pem_specimen_code }}" data-reg="{{ $code }}">{{ $spec->s_specimen_data_name }}</button>
                            </span>
                            @endif
                            <script>
        ...
        <button class="btn btn-falcon-primary btn-sm" id="button-simpan-proses-specimen-collection" data-code="{{ $code }}">Simpan</button>
    </div>
</div>
