    ...
    <div class="card-body bg-light">
        ...
        <div class="card my-3 border border-warning">
            <div class="card-body d-flex justify-content-between ">
                ...
                <div class="d-flex">
                    <button class="btn btn-falcon-primary" id="button-simpan-proses-result"><span class="far fa-save"></span> Simpan</button>
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td style="width: 20%;">
                                ...
                                <div class="input-group has-validation">
                                    <input type="text" class="form-control" name="{{$subs->t_pem_list_val_code}}" id="validationTooltipUsername"
                                        aria-describedby="validationTooltipUsernamePrepend" required="" value="{{ $nilai->h_reg_lab_value }}">
                                    <span class="input-group-text" id="validationTooltipUsernamePrepend">{{$subs->t_pem_list_val_satuan}}</span>
