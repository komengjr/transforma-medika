            ...
            <div class="row gx-0 flex-between-center">
                ...
                <div class="col-xl-auto px-3 py-2">
                    ...
                    <h4 class="text-primary fw-bold mb-0">Laboratorium <span
                            class="text-primary fw-medium">Dokumentasi Hasil</span>
                    </h4>
                </div>
            </div>
        </div>
        ...
        <div class="sticky-sidebar">
            <div class="card mb-lg-0">
                ...
                <div class="card-body bg-light">
                    ...
                    <div class="col-12 mb-2">
                        <div class="card border h-100 border-warning remove-class" id="button-dokumentasi-hasil-rad"
                            ...
                            <div class="card-body fs--2 text-dark py-2">
                                ...
                                <p class="card-text">No. reg : <strong class="text-warning">{{$datas->d_reg_order_rad_code }}</strong>
                                </p>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).on("click", "#button-dokumentasi-hasil-rad", function(e) {
        ...
        $(".remove-class").removeClass("bg-primary");
