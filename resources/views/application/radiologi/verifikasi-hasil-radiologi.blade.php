    ...
    <div class="card-body border-top p-3">
        <table id="example" class="table table-bordered table-striped" style="width:100%">
            ...
            <tbody class="fs--2">
                ...
                ->first();
                @endphp
                <tr id="button-verifikasi-hasil" data-code="{{ $datas->d_reg_order_code }}" data-reg="{{ $datas->d_reg_order_rad_code  }}" data-bs-toggle="modal" data-bs-target="#modal-radiologi-full">
                    <td>{{ $no++ }}</td>
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                <button class="dropdown-item" data-bs-toggle="modal"
                                    ...
                                    Proses Verifikasi Pasien</button>
                            </div>
                        </div>
                    </td>
                </tr>
...
@endsection
@section('base.js')
<div class="modal fade" id="modal-radiologi-full" data-bs-keyboard="false" data-bs-backdrop="static"
