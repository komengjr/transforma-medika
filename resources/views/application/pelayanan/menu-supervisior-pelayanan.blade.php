            ...
            <div class="card bg-200 shadow border border-primary">
                <div class="row gx-0 flex-between-center">
                    ...
                    <div class="col-xl-auto px-3 py-2">
                        ...
                        <h4 class="text-primary fw-bold mb-0">Supervisior <span
                                class="text-primary fw-medium">Pelayanan</span>
                        </h4>
                    </div>
                </div>
            </div>
        ...
        <div class="card-header bg-primary">
            <div class="d-flex justify-content-between">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <input class="form-control form-control-lg datetimepicker" id="timepicker3" type="text"
                ...
                <div class="d-flex" style="padding-left: 10px;">
                    <button class="btn btn-falcon-warning" id="button-pencarian-data-pasien"><span
...
@section('base.js')
    ...
    <div class="modal fade" id="modal-supervisior" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="false">
