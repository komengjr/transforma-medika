<div class="row navbar-vertical-label-wrapper mt-3 mb-2">
    <div class="col-auto navbar-vertical-label">
        <h4><span class="badge bg-danger">RADIOLOGI</span></h4>
    </div>
    <div class="col ps-0">
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="input-group"> <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
            <input type="file" name="file" id="file" class="form-control form-control-lg border-start-0">
        </div>
    </div>
</div>
<div class="row navbar-vertical-label-wrapper mt-3 mb-2">
    ...
    <div class="col-xl-7">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <label class="form-label" for="field-type">Agreement</label>
                        <select class="form-select choices-single-paket" id="pilih_agrement">
...
<script>
    ...
    $('#pilih_agrement').on("change", function() {
        var dataid = document.getElementById("pilih_agrement").value;
        console.log(dataid);
        ...
        if (dataid == "") {
            ...
            $.ajax({
                url: "{{ route('registrasi_pasien_pilih_data_pasien_kebutuhan_pilih_poli_agrement') }}",
                type: "POST",
                cache: false,
                data: {
                    "_token": "{{ csrf_token() }}",
...
<script>
    $(document).on("click", "#button-fix-registrasi-rad", function(e) {
        e.preventDefault();
