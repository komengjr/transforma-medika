            ...
            <div class="row gx-0 flex-between-center">
                <div class="col-sm-auto d-flex align-items-center border-bottom">
                    ...
                    <div>
                        ...
                        <h4 class="text-info fw-bold mb-1">Medika <span class="text-info fw-medium">Management
                                System</span></h4>
                    </div>
                ...
                <div class="position-relative z-index-2">
                    ...
                    <div class="d-flex py-3">
                        <div class="pe-3">
                            ...
                            <h4 class="text-info mb-0 fs--1 fs-md-2">23 Order</h4>
                        </div>
                        <div class="ps-3">
                            <p class="text-600 fs--1 mb-1">Order Batal</p>
                            <h4 class="text-danger mb-0 fs--1 fs-md-2">2 Order</h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row g-2 flex-between-center">
                            <div class="col">
                                <div class="d-flex">
                                    ...
                                    <p class="fs--1 ps-2 mb-0"><strong>0 Order</strong> didn’t publish to your Page</p>
                                </div>
                            </div>
                                    ...
                                    <div class="fs--2 mt-3">
                                        <div class="d-flex flex-between-center mb-1">
                                            <div class="d-flex align-items-center"><span
                                                    class="dot bg-primary"></span><span class="fw-semi-bold">Falcon</span>
                                            </div>
