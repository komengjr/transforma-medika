    ...
    <form>
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-xl-5 col-xxl-5 ps-lg-4 ps-xl-2 ps-xxl-5 text-center text-md-start text-xl-center text-xxl-start">
                ...
                <div class="fs-2 fw-semi-bold">All Total: <span class="text-primary">@currency($data->kop_log_peminjaman_brg_nominal)</span></div>
                <button class="btn btn-success mt-3 px-5" type="button" id="button-fix-payment-kontrak-bulanan" data-code="{{ $data->kop_log_peminjaman_barang_code }}">Confirm &amp; Pay</button>
