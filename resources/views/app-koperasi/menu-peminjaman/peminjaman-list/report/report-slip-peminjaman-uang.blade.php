...
<body>
    ...
    <table class="meta-info">
        ...
        <tr>
            <td>No Reg</td>
            <td>:</td>
            <td>{{ $data->kop_proses_uang_code }}</td>
            <td></td>
            <td></td>
            <td></td>
        </tr>
        <tr>
            <td>Nama</td>
            <td>:</td>
            <td>{{ $data->kop_master_peserta_name }}</td>
            <td>Cabang :</td>
            <td>:</td>
            <td>Bagian :</td>
        </tr>
                ...
                <div class="section-left">
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td colspan="2" class="col-value">@currency($data->kop_proses_uang_nominal)</td>
                        ...
                        <tr>
                            ...
                            <td class="col-colon">:</td>
                            <td colspan="2" class="col-value">{{ $data->kop_proses_uang_tgl }}</td>
                        </tr>
                        <tr>
                            <td class="col-num">3.</td>
                            <td class="col-label">Lama Pinjaman</td>
                            <td class="col-colon">:</td>
                            <td colspan="2" class="col-value">{{ $data->kop_proses_uang_tenor }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="col-colon">:</td>
                            <td class="col-currency">@currency($data->kop_proses_uang_nominal)</td>
                            <td class="col-value"></td>
                        </tr>
                    </table>
                </div>
            ...
            <tr>
                <td style="width: 50%;">
                    <div style="width: 50%;" class="info-blue">
                        Dana yang diserahkan &nbsp;: <small style="color: #000;">@currency($data->kop_proses_uang_nominal)</small>
                    </div>
                </td>
                <td style="width: 50%;">
                    <div style="width: 50%;" class="info-blue">
                        Untuk Keperluan : <small style="color: #000;">{{ $data->kop_proses_uang_keperluan }}</small>
                    </div>
