            ...
            <div class="card-header bg-300">
                <div class="row flex-between-center">
                    ...
                    <div class="col-sm-auto" id="loading-button-kirim">
                        <a class="btn btn-falcon-primary btn-sm" href="#!" id="button-kirim-verifikasi-pengajuan" data-code="{{ $data->kop_proses_uang_code }}">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3 mb-md-0">
                        @php
                        $kacab = DB::table('kop_user_verifikasi')->where('kop_user_verifikasi_code',$data->kop_proses_uang_kacab)->first();
                        @endphp
                    ...
                    <div class="col-md-6">
                        @php
                        $kacab = DB::table('kop_user_verifikasi')->where('kop_user_verifikasi_code',$data->kop_proses_uang_ketua)->first();
                        @endphp
