...
<body>
    ...
    <div class="letter-paper">
        <div class="header">
            <h1>SURAT PERMOHONAN PEMINJAMAN BARANG</h1>
        ...
        <div class="form-section">
            <div class="input-group">
                ...
                <input type="text" id="data-code" value="{{ $data->kop_proses_brg_code }}" hidden>
            </div>

            <div class="input-group">
                <label>Nominal Peminjaman Uang (Rp)</label>
                <input type="text" id="input-nominal" value="@currency($data->kop_proses_brg_nominal)" readonly>
            </div>
        ...
        <div class="content">
            <p>Saya yang bertanda tangan di bawah ini mengajukan permohonan Peminjaman Barang dengan rincian data di atas. Saya bertanggung jawab penuh atas penggunaan voucher tersebut sesuai dengan kebijakan perusahaan.</p>
        </div>
        ...
        <div class="signature-wrapper">
            <div class="signature-box">
                ...
                <div class="button-group">
                    <input type="text" name="vocher_code" id="vocher_code" value="{{ $data->kop_proses_verif_brg_code }}" hidden>
        ...
        function saveData() {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('data_peminjaman_barang_sign') }}",
                        type: "POST",
                        cache: false,
                        data: {
                            "_token": "{{ csrf_token() }}",
