<div class="modal-body p-0">
    <div class="bg-primary rounded-top-lg py-3 ps-4 pe-6">
        <h4 class="mb-1" style="color: white;" id="staticBackdropLabel">Form add Data Simpanan Wajib</h4>
    ...
    <div class="p-4 pb-3" id="menu-add-data-pr-all">
        <form class="row g-3 pb-3" id="form-simpanan-wajib-baru" method="POST">
            @csrf
            <div class="col-md-6">
                <label for="inputLastName1" class="form-label">Nama Simpanan wajib</label>
                <div class="input-group"> <span class="input-group-text"><i class="fas fa-map-marked-alt"></i></span>
                    <input type="text" name="nama_simpanan" class="form-control form-control-lg border-start-0"
                        id="nama_simpanan" placeholder="Ex. Simpanan Wajib A">
                </div>
            </div>
            <div class="col-md-6">
                <label for="inputLastName1" class="form-label">Nominal Simpanan Wajib</label>
                <div class="input-group"> <span class="input-group-text"><i class="fas fa-map-marked-alt"></i></span>
