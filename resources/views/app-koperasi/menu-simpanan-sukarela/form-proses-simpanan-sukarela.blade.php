<div class="modal-body p-0">
    <div class="bg-primary rounded-top-lg py-3 ps-4 pe-6">
        <h4 class="mb-1" style="color: white;" id="staticBackdropLabel">Form Proses Data Simpanan Sukarela</h4>
            ...
            <div class="card-body border border-dark">
                <form class="row" id="form-proses-vocher-baru" method="post">
                    ...
                    <div class="col-md-5 col-xl-5 col-xxl-5 ps-lg-4 ps-xl-2 ps-xxl-5 text-center text-md-start text-xl-center text-xxl-start">
                        ...
                        <div class="fs-2 fw-semi-bold">All Total: <span class="text-primary">@currency($data->kop_tagihan_bulan_peserta_nominal)</span></div>
                        <span id="menu-proses-data-simpanan">
                            <button class="btn btn-success mt-3 px-5" type="button" id="button-payment-data-penyimpanan-sukarela" data-code="">Confirm &amp; Prosess</button>
                        </span>
