...
@section('content')
        ...
        <div class="col-xl-6 col-lg-12">
            <div class="card h-100">
                ...
                <div class="card-header z-index-1">
                    <h5 class="text-primary">Selamat datang {{Auth::user()->fullname}} ! </h5>
                ...
                <div class="card-body z-index-1">
                    <div class="row g-2 h-100 align-items-end">
                        ...
                        <div class="col-sm-6 col-md-5">
                            <div class="d-flex position-relative">
                                <div class="icon-item icon-item-sm border rounded-3 shadow-none me-2">
                                    <span class="fas fa-user-shield text-warning"></span>
                                </div>
                                <div class="flex-1"><a class="stretched-link" href="#!">
                        ...
                        <div class="col-sm-6 col-md-5">
                            <div class="d-flex position-relative">
                                <div class="icon-item icon-item-sm border rounded-3 shadow-none me-2">
                                    <span class="fas fa-project-diagram text-success"></span>
                                </div>
                                <div class="flex-1"><a class="stretched-link" href="#!">
                                        <h6 class="text-800 mb-0">Membuat Project</h6>
                                    </a>
                                    <p class="mb-0 fs--2 text-500">Manage and update your Project</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-5">
                            <div class="d-flex position-relative">
                                ...
                                <div class="flex-1"><a class="stretched-link" href="#!">
                                        <h6 class="text-800 mb-0">Project activity</h6>
                                    </a>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card h-100">
                <div class="card-header d-flex flex-between-center">
                    <h5 class="mb-0">Belum Ada Project</h5><a class="btn btn-warning btn-sm px-2" href="#!">Detail<span
                            class="fas fa-chevron-right ms-1 fs--2"> </span></a>
                </div>
                <div class="card-body">
                    <p class="fs--1 text-600">Lihat Selengkapnya Untuk Melihat <br /> Aktifitas levels, dan
                        progress</p>
                ...
                <div class="card-body d-flex align-items-end">
                    <div class="row g-3 justify-content-between">
                        <div class="col-10 mt-0">
                            <p class="fs--1 text-600 mb-0">The very first general meeting for planning
                                Falcon’s design and development roadmap</p>
                        </div>
                        <div class="col-auto">
                            <a href="{{ route('project.create_event') }}" class="btn btn-primary w-100 fs--1" type="button"><span
                                    class="fas fa-folder-plus me-2"></span>Project Baru</a>
                        </div>
    ...
    <div class="row g-3 mb-2">
                ...
                <div class="card-header bg-light d-flex flex-between-center">
                    ...
                    <div class="dropdown font-sans-serif btn-reveal-trigger">
                        ...
                        <div class="dropdown-menu dropdown-menu-end border py-2"><a class="dropdown-item"
                                href="#!">Edit</a><a class="dropdown-item" href="#!">Move</a><a
                ...
                <div class="card-header bg-light py-2 d-flex flex-between-center">
                    ...
                    <div class="dropdown font-sans-serif btn-reveal-trigger">
                        ...
                        <div class="dropdown-menu dropdown-menu-end border py-2"
                            aria-labelledby="dropdown-members-activity"><a class="dropdown-item"
                                href="#!">Selengkapnya</a><a class="dropdown-item" href="#!">Export</a>
        ...
        <div class="col-xl-8 order-xxl-2">
            <div class="card h-100">
                            ...
                            <tbody>
                                <tr class="border-bottom border-200">
                                        ...
                                        <div class="d-flex align-items-center position-relative">
                                            ...
                                            <div class="flex-1 ms-3">
                                                <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900"
                                                        href="../pages/user/profile.html">Gavin Belson</a>
                                                </h6>
                                    ...
                                    <td class="align-middle text-center"><small
                                            class="badge fw-semi-bold rounded-pill badge-soft-warning">Late</small>
                                    </td>
                                    <td class="align-middle text-center"><small
                                ...
                                <tr class="border-bottom border-200">
                                    <td>
                                        <div class="d-flex align-items-center position-relative">
                                            <div class="avatar avatar-2xl status-online">
                                                <img class="rounded-circle" src="../assets/img/team/9.jpg"
                                                    alt="" />

                                            </div>
                                            <div class="flex-1 ms-3">
                                                <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900"
                                                        href="../pages/user/profile.html">Rsuss
                                                        Hanneman</a></h6>
                                                <p class="text-500 fs--2 mb-0">Smart Learning Management
                                                </p>
                                            </div>
                                        </div>
                                    </td>
        ...
        <div class="col-12 order-xxl-3">
            <div class="card" id="runningProjectTable" data-list='{"valueNames":["projects","worked","time","date"]}'>
                <div class="card-header">
                    <h6 class="mb-0">Progress Projects Event</h6>
                </div>
                <div class="card-body p-0">
                    <div class="scrollbar">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="avatar-group justify-content-end">
                                            ...
                                            <div class="avatar avatar-xl border border-3 border-light rounded-circle">
                                                <div class="avatar-name rounded-circle "><span>+2</span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center position-relative">
                                            ...
                                            <div class="flex-1 ms-3">
                                                <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900"
                                                        href="../pages/user/profile.html">UI/UX
                                                        Redesign</a></h6>
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="progress rounded-3 worked" style="height: 6px;">
                                            <div class="progress-bar bg-progress-gradient rounded-pill" role="progressbar"
                                                style="width: 70%" aria-valuenow="43.72" aria-valuemin="0"
                                                aria-valuemax="100"></div>
                                        </div>
                                    </td>
                                    <td class="align-middle text-center time">
                                    ...
                                    <td>
                                        <div class="avatar-group justify-content-end">
                                            ...
                                            <div class="avatar avatar-xl border border-3 border-light rounded-circle">
                                                <div class="avatar-name rounded-circle "><span>+5</span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                ...
                <div class="card-footer bg-light py-0 text-center"><a class="btn btn-sm btn-link py-2"
                    ...
                    <div class="dropdown font-sans-serif btn-reveal-trigger">
                        <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal"
                            ...
                            data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span
                                class="fas fa-ellipsis-h fs--2"></span></button>
                        <div class="dropdown-menu dropdown-menu-end border py-2"
                            aria-labelledby="dropdown-project-statistics"><a class="dropdown-item"
                ...
                <div class="card-body scrollbar recent-activity-body-height ps-2">
                        ...
                        <div class="col">
                            <div class="row gx-0 border-bottom pb-card">
                                <div class="col">
                                    ...
                                    <p class="fs--1 text-600 mb-0">Got an email for previous year sale
                                        report</p>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="col">
                            <div class="row gx-0 border-bottom pb-card">
                                <div class="col">
                                    ...
                                    <p class="fs--1 text-600 mb-0">A finished project's board is archived
                                        recently</p>
                                </div>
                                <div class="col-auto">
                    ...
                    <div class="row g-3 timeline timeline-primary timeline-current pb-card">
                        ...
                        <div class="col">
                            <div class="row gx-0 border-bottom pb-card">
                                <div class="col">
                                    <h6 class="text-800 mb-1">Falcon v3.0.0 released with new features
                                    </h6>
                                    <p class="fs--1 text-600 mb-0">Falcon new version is released
                                        successfully with new Dashboards</p>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="col">
                            <div class="row gx-0">
                                <div class="col">
                                    ...
                                    <p class="fs--1 text-600 mb-0">Fixed some bugs and spelling errors on
                                        this update</p>
                                </div>
                                <div class="col-auto">
                ...
                <div class="card-body p-0 management-calendar">
                    <div class="row g-3">
                        ...
                        <div class="col-md-5 bg-light pt-3">
                            <div class="px-3">
                                <h4 class="mb-0 fs-0 fs-sm-1 fs-lg-2" id="management-calendar-title">
                                </h4>
        ...
        <div class="col-xxl-4">
            <div class="card h-100">
                ...
                <div class="card-body p-0 scrollbar to-do-list-body-height">
                    <div
                        ...
                        <div class="form-check mb-0 d-flex align-items-center">
                            ...
                            <label class="form-check-label mb-0 p-3" for="checkbox-todo-0">Design a
                                facebook ad</label>
                        </div>
                    ...
                    <div
                        ...
                        <div class="form-check mb-0 d-flex align-items-center">
                            ...
                            <label class="form-check-label mb-0 p-3" for="checkbox-todo-1">Analyze
                                Data</label>
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="hover-actions">
                    ...
                    <div
                        ...
                        <div class="form-check mb-0 d-flex align-items-center">
                            ...
                            <label class="form-check-label mb-0 p-3" for="checkbox-todo-4">Meeting at
                                12</label>
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="hover-actions">
                    ...
                    <div
                        ...
                        <div class="form-check mb-0 d-flex align-items-center">
                            ...
                            <label class="form-check-label mb-0 p-3" for="checkbox-todo-5">Meeting at
                                10</label>
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="hover-actions">
                ...
                <div class="card-footer bg-light p-0"><a class="btn btn-sm btn-link d-block py-2" href="#!"><span
                            class="fas fa-plus me-1 fs--2"></span>Add New Task</a>
                </div>
            </div>
        </div>
    </div> --}}
