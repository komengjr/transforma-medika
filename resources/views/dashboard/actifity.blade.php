        ...
        <div class="card-body fs--1 p-0">
            <a class="border-bottom-0 notification rounded-0 border-x-0 border border-300" href="#!">
                ...
                <div class="notification-body">
                    <p class="mb-1"><strong>Anthony Hopkins</strong> Followed <strong>Massachusetts Institute of
                            Technology</strong></p>
            ...
            <a class="border-bottom-0 notification rounded-0 border-x-0 border border-300" href="#!">
                ...
                <div class="notification-body">
                    <p class="mb-1"><strong>Rowan Atkinson</strong> Tagged <strong>Anthony Hopkins</strong> in a live
                        video</p>
            ...
            <a class="border-bottom-0 notification rounded-0 border-x-0 border border-300" href="#!">
                ...
                <div class="notification-body">
                    <p class="mb-1"><strong>Robert Downey</strong> mention <strong>Anthony Hopkins</strong> in a comment
                    </p>
            ...
            <a class="border-bottom-0 notification rounded-0 border-x-0 border border-300" href="#!">
                ...
                <div class="notification-body">
                    <p class="mb-1"><strong>Anthony Hopkins</strong> joined <strong>Victory day cultural Program</strong>
                        with <strong>Tony Stark</strong></p>
