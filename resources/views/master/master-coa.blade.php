            ...
            <div class="card bg-100 shadow-none border border-primary">
                <div class="row gx-0 flex-between-center">
                    ...
                    <div class="col-xl-auto px-3 py-2">
                        ...
                        <h4 class="text-primary fw-bold mb-0">Master <span class="text-info fw-medium">Chart Of Account</span></h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card mb-3">
        <div class="card-header bg-primary">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="m-0"><span class="badge bg-primary m-0 p-0">Master Chart Of Account</span></h3>
                </div>
                <div class="col-auto">
