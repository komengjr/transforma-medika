            ...
            <div class="card bg-100 shadow-none border">
                <div class="row gx-0 flex-between-center">
                    ...
                    <div class="col-xl-auto px-3 py-2">
                        ...
                        <h4 class="text-primary fw-bold mb-0">Master <span class="text-info fw-medium">Gateway WA</span></h4>
                    </div>
                </div>
            </div>
        </div>
...
@section('base.js')
    ...
    <script>
        $(document).on("click", "#button-krim-pesan", function(e) {
            e.preventDefault();
            ...
            $.ajax({
                url: "{{ route('master_gateway_whatsapp_send_message') }}",
                type: "POST",
                cache: false,
                data: {
                    "_token": "{{ csrf_token() }}",
