            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="#" class="text-dark link-hover me-3"><i class="fa fa-clock"></i> {{ $data->news_data_published_at }}</a>
                        <a href="#" class="text-dark link-hover me-3"><i class="fa fa-eye"></i> {{ $views }} Views</a>
                        <a href="#" class="text-dark link-hover me-3"><i class="fa fa-comment-dots"></i> {{$coment->count()}} Comment</a>
                    ...
                    <div class="row g-4">
                        <div class="col-6">
                            <div class="rounded overflow-hidden">
                                <img src="{{ asset('news/img/news-6.jpg') }}" class="img-zoomin img-fluid rounded w-100"
                                    alt="">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="rounded overflow-hidden">
                                <img src="{{ asset('news/img/news-5.jpg') }}" class="img-zoomin img-fluid rounded w-100"
                                    alt="">
                            </div>
                        </div>
                    </div>
