    ...
    <div class="card mb-3">
        <div class="card-header bg-primary">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="m-0"><span class="badge bg-primary m-0 p-0">Chart Of Account</span></h3>
                </div>
                <div class="col-auto">
                        ...
                        <ul class="collapse treeview-list" id="treeviewStriped-1-{{$datas->id_acc_master_coa}}"
                            ...
                            @foreach ($sub as $subs)
                                @if ($subs->acc_coa_data_opt == 1)
                                    <li class="treeview-list-item">
                                        <a data-bs-toggle="collapse" href="#treeviewStriped-2-{{$subs->id_acc_master_coa_data}}"
                                        ...
                                        <ul class="collapse treeview-list" id="treeviewStriped-2-{{$subs->id_acc_master_coa_data}}"
                                            ...
                                            @foreach ($sub1 as $subs1)
                                                @if ($subs1->acc_coa_data_opt == 1)
                                                    <li class="treeview-list-item">
                                                        <a data-bs-toggle="collapse" href="#treeviewStriped-2-{{$subs1->id_acc_master_coa_data}}" role="button"
                                                            aria-expanded="false">
                                                            <p class="treeview-text">
                                                                <span class="text-warning me-2">{{$datas->acc_master_coa_no}}.{{ $no-1 }}.{{ $no1++ }}</span> {{$subs1->acc_coa_data_name}}
                                                            </p>
                                                        </a>
                                                        <ul class="collapse treeview-list" id="treeviewStriped-2-{{$subs1->id_acc_master_coa_data}}" data-show="false">
                                                            @php
                                                            ...
                                                            @foreach ($sub2 as $subs2)
                                                                @if ($subs2->acc_coa_data_opt == 1)
                                                                    <li class="treeview-list-item">
                                                                        <a data-bs-toggle="collapse" href="#treeviewStriped-3-{{$subs2->id_acc_master_coa_data}}" role="button"
                                                                            aria-expanded="false">
                                                                            <p class="treeview-text">
                                                                                <span class="text-warning me-2">{{$datas->acc_master_coa_no}}.{{ $no-1 }}.{{ $no1-1 }}.{{ $no2++ }}</span> {{$subs2->acc_coa_data_name}}
                                                                            </p>
                                                                        </a>
                                                                        <ul class="collapse treeview-list" id="treeviewStriped-3-{{$subs2->id_acc_master_coa_data}}" data-show="false">
                                                                            @php
                                                                    ...
                                                                    <li class="treeview-list-item">
                                                                        <div class="treeview-item">
                                                                            <a class="flex-1" href="#!">
                                                                                <p class="treeview-text">
                                                                                    <span class="me-2 fas fa-universal-access text-primary"></span>
                                                                                    <span class="text-warning me-2">{{$datas->acc_master_coa_no}}.{{ $no }}.{{ $no1++ }}</span> {{$subs2->acc_coa_data_name}}
                                                                                </p>
                                                                            </a>
                                                                            <div class="dot bg-info"></div>
                                                                        </div>
                            ...
                            <li class="treeview-list-item">
                                <div class="treeview-item">
                                    <a class="flex-1" href="#!" id="button-add-level" data-bs-toggle="modal" data-bs-target="#modal-coa" data-level="1" data-code="{{ $datas->acc_master_coa_code }}">
                                        <p class="treeview-text">
                                            <span class="me-2 fas fa-plus-circle text-success"></span>
                                            add Data
                                        </p>
