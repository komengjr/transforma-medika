...
<div class="card mb-3">
    <div class="card-header position-relative min-vh-25 mb-7">
        ...
        <div class="avatar avatar-5xl avatar-profile"><img class="rounded-circle img-thumbnail shadow-sm"
                src="{{ asset('asset/img/team/4.jpg') }}" width="200" alt="" /></div>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-lg-8">
                <h4 class="mb-1"> {{Auth::user()->fullname}}<span data-bs-toggle="tooltip" data-bs-placement="right"
            ...
            <div class="col ps-2 ps-lg-3">
                <!-- <a class="d-flex align-items-center mb-2" href="#"><span class="fas fa-user-circle fs-3 me-2 text-700"
                            data-fa-transform="grow-2"></span>
                        <div class="flex-1">
                            <h6 class="mb-0">See followers (330)</h6>
                        </div>
                    </a>
                    <a class="d-flex align-items-center mb-2" href="#"><img class="align-self-center me-2"
                            src="{{ asset('asset/img/logos/g.png') }}" alt="Generic placeholder image" width="30" />
                        <div class="flex-1">
                            <h6 class="mb-0">Google</h6>
                        </div>
                    </a>
                    <a class="d-flex align-items-center mb-2" href="#"><img class="align-self-center me-2"
                            src="{{ asset('asset/img/logos/apple.png') }}" alt="Generic placeholder image" width="30" />
                        <div class="flex-1">
                            <h6 class="mb-0">Apple</h6>
                        </div>
                    </a>
                    <a class="d-flex align-items-center mb-2" href="#"><img class="align-self-center me-2"
                            src="{{ asset('asset/img/logos/hp.png') }}" alt="Generic placeholder image" width="30" />
                        <div class="flex-1">
    ...
    <div class="col-lg-8 pe-lg-2">
        <div class="card mb-3">
            <div class="card-header bg-primary">
                <div class="d-flex justify-content-between">
                    <div>
                        <h5 class="mt-1 text-white">Deskripsi Pegawai</h5>
                    </div>
                    <div class="d-flex">
                        <button class="btn btn-falcon-default btn-sm mb-1" type="button" data-bs-toggle="modal" data-bs-target="#modal-hrm" id="button-update-desc-pegawai">
            ...
            <div class="card-footer bg-light p-0 border-top">
                <button class="btn btn-link d-block w-100 btn-intro-collapse" type="button" data-bs-toggle="collapse"
                    data-bs-target="#profile-intro" aria-expanded="true" aria-controls="profile-intro">Show <span
                        class="less">less<span class="fas fa-chevron-up ms-2 fs--2"></span></span><span
                        class="full">full<span class="fas fa-chevron-down ms-2 fs--2"></span></span></button>
            </div>
        </div>
        <div class="card mb-3">
                ...
                <div class="row">
                    <div class="col-sm-6 mb-3">
                        <div class="d-flex position-relative align-items-center mb-2"><img
                                ...
                                src="{{ asset('asset/img/logos/apple.png') }}" alt="" width="50" />
                            <div class="flex-1">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="d-flex position-relative align-items-center mb-2"><img
                                class="d-flex align-self-center me-2 rounded-3"
                                src="{{ asset('asset/img/logos/g.png') }}" alt="" width="50" />
                            <div class="flex-1">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="d-flex position-relative align-items-center mb-2"><img
                                class="d-flex align-self-center me-2 rounded-3"
                                src="{{ asset('asset/img/logos/intel-2.png') }}" alt="" width="50" />
                            <div class="flex-1">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="d-flex position-relative align-items-center mb-2"><img
                                class="d-flex align-self-center me-2 rounded-3"
                                src="{{ asset('asset/img/logos/facebook.png') }}" alt="" width="50" />
                            <div class="flex-1">
        ...
        <div class="card mb-3 mb-lg-0">
            ...
            <div class="card-body overflow-hidden">
                <div class="row g-0">
                    <div class="col-6 p-1">
                        <a class="glightbox" href="{{ asset('asset/img/generic/4.jpg') }}" data-gallery="gallery1"
                            data-glightbox="data-glightbox"><img class="img-fluid rounded"
                                src="{{ asset('asset/img/generic/4.jpg') }}" alt="..." /></a>
                    </div>
                    <div class="col-6 p-1">
                        <a class="glightbox" href="{{ asset('asset/img/generic/5.jpg') }}" data-gallery="gallery1"
                            data-glightbox="data-glightbox"><img class="img-fluid rounded"
                                src="{{ asset('asset/img/generic/5.jpg') }}" alt="..." /></a>
                    </div>
                    <div class="col-4 p-1">
                        <a class="glightbox" href="{{ asset('asset/img/gallery/4.jpg') }}" data-gallery="gallery1"
                            data-glightbox="data-glightbox"><img class="img-fluid rounded"
                                src="{{ asset('asset/img/gallery/4.jpg') }}" alt="..." /></a>
                    </div>
                    <div class="col-4 p-1">
                        <a class="glightbox" href="{{ asset('asset/img/gallery/5.jpg') }}" data-gallery="gallery1"
                            data-glightbox="data-glightbox"><img class="img-fluid rounded"
                                src="{{ asset('asset/img/gallery/5.jpg') }}" alt="..." /></a>
                    </div>
                    <div class="col-4 p-1">
                        <a class="glightbox" href="{{ asset('asset/img/gallery/3.jpg') }}" data-gallery="gallery1"
                            data-glightbox="data-glightbox"><img class="img-fluid rounded"
                                src="{{ asset('asset/img/gallery/3.jpg') }}" alt="..." /></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="sticky-sidebar">
            <div class="card mb-3">
                ...
                <div class="card-body fs--1">
                    <div class="d-flex"><a href="#!"> <img class="img-fluid" src="{{ asset('asset/img/logos/g.png') }}"
                                alt="" width="56" /></a>
                    ...
                    <div class="d-flex"><a href="#!"> <img class="img-fluid"
                                src="{{ asset('asset/img/logos/apple.png') }}" alt="" width="56" /></a>
                        <div class="flex-1 position-relative ps-3">
                    ...
                    <div class="d-flex"><a href="#!"> <img class="img-fluid"
                                src="{{ asset('asset/img/logos/nike.png') }}" alt="" width="56" /></a>
                        <div class="flex-1 position-relative ps-3">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body fs--1">
                    ...
                    <div class="d-flex"><a href="#!"> <img class="img-fluid"
                                src="{{ asset('asset/img/logos/staten.png') }}" alt="" width="56" /></a>
                        <div class="flex-1 position-relative ps-3">
                    ...
                    <div class="d-flex"><a href="#!"> <img class="img-fluid"
                                src="{{ asset('asset/img/logos/tj-heigh-school.png') }}" alt="" width="56" /></a>
                        <div class="flex-1 position-relative ps-3">
                            <h6 class="fs-0 mb-0"> <a href="#!">Thomas Jefferson High School for Science and
...
@endsection
@section('base.js')
<div class="modal fade" id="modal-hrm" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1"
