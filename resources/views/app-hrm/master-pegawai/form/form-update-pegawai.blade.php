<div class="modal-body p-0">
    ...
    <div class="p-4 pb-0" id="menu-add-data-pr-all">
        <form class="row g-3 pb-3" id="form-pegawai-baru" method="POST">
            @csrf
            ...
            <div class="col-md-4">
                ...
                <div class="input-group"> <span class="input-group-text"><i class="fas fa-calendar-day"></i></span>
                    <input type="date" name="dob" class="form-control form-control-lg border-start-0" id="tgl_lahir"
            ...
            <div class="col-md-4">
                ...
                <div class="input-group"> <span class="input-group-text"><i class="fas fa-map-marked-alt"></i></span>
                    <input type="text" name="place" class="form-control form-control-lg border-start-0"
            ...
            <div class="col-md-4">
                ...
                <div class="input-group"> <span class="input-group-text"><i class="fas fa-phone-square-alt"></i></span>
                    <input type="text" name="hp" class="form-control form-control-lg border-start-0" id="no_hp"
            ...
            <div class="col-md-4">
                <label for="inputLastName1" class="form-label text-youtube">Pilih Departemen</label>
            ...
            <div class="col-md-4">
                ...
                <div class="input-group"> <span class="input-group-text"><i class="fas fa-city"></i></span>
                    <select name="kecamatan" id="location" class="form-control form-control-lg single-select">
