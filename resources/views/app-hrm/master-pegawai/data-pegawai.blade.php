...
<div class="pegawait">
    <div class="filter-bar mb-4 border border-primary">
        <div class="row g-3 align-items-center">
            ...
            <div class="col-md-1">
                <button class="btn btn-warning" id="button-add-data-pegawai" data-bs-toggle="modal" data-bs-target="#modal-pegawai-xl">Add</button>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-4 col-lg-3 mb-4">
                    <div class="card card-pegawai text-center border border-primary">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-outline-success btn-sm rounded-pill" id='button-show-data-pegawai' data-bs-toggle='modal' data-bs-target='#modal-pegawai-xl' data-code='${p.code}'>
                                <i class="bi bi-envelope"></i> Lihat Data
                            </a>
                            <a href="#" class="btn btn-outline-warning btn-sm rounded-pill" id='button-update-data-pegawai' data-bs-toggle='modal' data-bs-target='#modal-pegawai-xl' data-code='${p.code}'>
...
<script>
    ...
    $(document).on("click", "#button-update-data-pegawai", function(e) {
        e.preventDefault();
    ...
    $(document).on("click", "#button-show-data-pegawai", function(e) {
        e.preventDefault();
        var code = $(this).data("code");
        $('#menu-pegawai-xl').html(
            '<div class="spinner-border my-3" style="display: block; margin-left: auto; margin-right: auto;" role="status"><span class="visually-hidden">Loading...</span></div>'
