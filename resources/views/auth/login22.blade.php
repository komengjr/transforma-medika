...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>e - Trans | Login Page</title>


    <!-- ===============================================-->
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/img/icons/spot-illustrations/falcon.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/img/icons/spot-illustrations/falcon.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/img/icons/spot-illustrations/falcon.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/img/icons/spot-illustrations/falcon.png') }}o">
    <link rel="manifest" href="../../../assets/img/favicons/manifest.json">
    <meta name="msapplication-TileImage" content="{{ asset('assets/img/icons/spot-illustrations/falcon.png') }}">
                                ...
                                <div class="col-md-5 text-center bg-card-gradient">
                                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                                        ...
                                        <div class="z-index-1 position-relative"><a
                                                ...
                                                href="../../../index.html">E - Trans Login</a>
                                    ...
                                    <div class="mt-3 mb-4 mt-md-4 mb-md-5 light">
                                        <p class="text-white">Tidak Mempunyai Akun ?<br><a
                                                ...
                                                href="{{ route('register') }}"><span class="far fa-address-card"> </span> Daftar Sekarang..</a>
                                        </p>
                                    ...
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <form action="{{ route('login.post') }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="card-email" type="text"
                                            ...
                                            <div class="mb-3">
                                                <button class="btn btn-primary d-block w-100 mt-3" type="submit"
                                                    name="submit"><span class="fab fa-500px"></span> Log in</button>
                                            </div>
                                        </form>
