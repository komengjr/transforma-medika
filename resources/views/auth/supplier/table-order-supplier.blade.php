        ...
        @foreach ($data as $datas)
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-supplier" id="button-update-order"
                        data-id="{{$info->pem_pr_order_code}}" data-code="{{ $datas->pem_pr_order_data_code }}"><span
